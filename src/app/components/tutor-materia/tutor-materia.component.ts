...
import { FormTutormateriaComponent } from 'src/app/Form/form-tutormateria/form-tutormateria.component';
...
export class TutorMateriaComponent implements OnInit, AfterViewInit{
  ...
  openDialog() {
    const dialogRef = this.dialog.open(FormTutormateriaComponent);
